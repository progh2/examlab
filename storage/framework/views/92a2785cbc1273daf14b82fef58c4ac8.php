...
<head>
    ...
    <title><?php echo e(config('app.name', 'examlab')); ?></title>
    <style>
    ...
    <div class="row" style="justify-content: space-between; margin-bottom: 16px;">
        <div class="row">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                <span class="pill">로그인됨: <?php echo e(auth()->user()->email); ?></span>
            <?php else: ?>
...
<?php /**PATH /Users/progh2/cursorprojects/examlab/resources/views/home.blade.php ENDPATH**/ ?>